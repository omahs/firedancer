...
$(call add-objs,main1 config security utility run/run run/tiles/tiles run/tiles/net run/tiles/netmux run/tiles/dedup run/tiles/pack run/tiles/quic run/tiles/verify run/tiles/bank run/tiles/shred keygen ready monitor/monitor monitor/helper configure/configure configure/large_pages configure/sysctl configure/shmem configure/xdp configure/xdp_leftover configure/ethtool configure/workspace_leftover configure/workspace,fd_fdctl)
